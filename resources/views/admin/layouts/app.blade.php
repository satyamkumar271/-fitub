    ...
    class="fixed inset-y-0 left-0 z-30 w-64 h-screen bg-gray-900 text-gray-300 transform transition-transform duration-300 ease-in-out 
           lg:translate-x-0 lg:static lg:inset-0 flex flex-col">
            ...
            <nav class="mt-8 px-4 flex-1 overflow-y-auto">
                ...
                {{-- Featured Professionals Link --}}
                <a href="{{ route('admin.featured-professionals.index') }}" class="mt-2 flex items-center px-4 py-2.5 rounded-lg transition-colors duration-200 gap-x-3
                    {{ request()->routeIs('admin.featured-professionals.*') ? 'bg-gray-800 text-white' : 'hover:bg-gray-800 hover:text-white' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
